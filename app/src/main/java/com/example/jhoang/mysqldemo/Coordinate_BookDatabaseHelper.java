...
public class Coordinate_BookDatabaseHelper extends SQLiteOpenHelper {
    ...
    public Coordinate_BookDatabaseHelper(Context context) {
        super(context, DATABASE_NAME, null, 1);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME + " (SHOWID TEXT PRIMARY KEY,SHOWNAME TEXT,NUMSETS TEXT)");
    }
    ...
    public boolean insertData(String showid,String showname,String numsets) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL_1,showid);
        contentValues.put(COL_2,showname);
        contentValues.put(COL_3, numsets);
    ...
    public boolean updateData(String showid,String showname,String numsets) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL_1,showid);
        contentValues.put(COL_2,showname);
